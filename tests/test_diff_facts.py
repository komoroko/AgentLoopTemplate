...
from agentloop import diff_facts
...
def test_coverage_manifest_only_emits_schema_fields() -> None:
    ...
    allowed = {
        "diff_digest", "analyzed_files", "analyzed_hunks", "unsupported_files", "generated_files",
        "languages", "deleted_lines_analyzed", "rename_semantics_analyzed", "dependency_semantics_analyzed",
        "binary_semantics_analyzed", "truncated", "partitioned", "coverage_status",
    }
