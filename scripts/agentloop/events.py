...
Usage:
  uv run --no-project --with pyyaml python scripts/agentloop/events.py --render
  uv run --no-project --with pyyaml python scripts/agentloop/events.py --add blocked --task T-003 --detail "..."
  uv run --no-project --with pyyaml python scripts/agentloop/events.py --resolve 3 --note "fixed by abc123"
"""
